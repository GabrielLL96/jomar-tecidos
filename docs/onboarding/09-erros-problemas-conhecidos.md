...
completo no arquivo 04, seção `create_order()`. **Lição geral**: RLS controla *quem* pode
escrever, nunca *que valor* está sendo escrito — qualquer INSERT client-side numa tabela
