-- Bug real achado testando o checkout no browser: `RETURNS TABLE (id uuid,
-- order_number text)` cria, dentro do corpo da function, uma variável
-- implícita chamada `id` — que colide com qualquer `where id = ...` não
-- qualificado nas queries internas (products/coupons/addresses têm coluna
-- `id`), gerando "column reference \"id\" is ambiguous" em runtime. Fix:
-- qualificar toda referência a `id` com o nome da tabela.
